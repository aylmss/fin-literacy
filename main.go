...
func main() {
	...
	Payments = []Payment{
		Payment{Id: "1", Title: "Salary", Price: 120,
			...
			Type: "Income", Comment: "comment for id1", Category: paymentCategories[1]},
		Payment{Id: "2", Title: "Rent", Price: 50,
			Date: time.Date(2022, time.February, 18, 11, 15, 0, 0, time.UTC),
			Type: "Expense", Comment: "comment for id2", Category: paymentCategories[2]},
		Payment{Id: "3", Title: "Magnum", Price: 20,
			Date: time.Date(2022, time.February, 15, 13, 50, 0, 0, time.UTC),
			Type: "Expense", Comment: "comment for id3", Category: paymentCategories[3]},
	}
